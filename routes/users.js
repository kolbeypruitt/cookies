...
router.post('/login', function (req, res, next) {
  // res.cookie('email', req.body.email);
  // res.cookie('password', req.body.password);
  cookiedb.find({email: req.body.email, password: req.body.password}, function (err, credentials) {
    res.redirect('loggedin');
  });
});

router.get('/loggedin', function (req, res, next) {
  res.render('loggedin', {email: req.cookies.fraggle, title: 'You have been securely logged into our super-secure network'})
});
